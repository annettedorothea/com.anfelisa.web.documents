...
export default class ReadNextCardOkEvent extends AbstractReadNextCardOkEvent {
    prepareDataForView() {
        ...
        this.eventData.data.formattedLast = ReadNextCardOkEvent.formatDate(this.eventData.data.last);
        this.eventData.data.formattedNext = ReadNextCardOkEvent.formatDate(this.eventData.data.next);
