...
const Translations = {
    de: {
        ...
        error: {
            readPublicCoursesFailed: "Öffentliche Kurse konnten nicht geladen werden.",
            readPublicLessonsFailed: "Öffentliche Lektionen konnten nicht geladen werden.",
            readPublicTestsFailed: "Öffentliche Tests konnten nicht geladen werden.",
            readPublicTestFailed: "Öffentlicher Test konnte nicht geladen werden.",
            ...
            readLastResultFailed: "Letztes Ergebnis konnte nicht geladen werden.",
            saveResultFailed: "Das Ergebnis konnte nicht gespeichert werden.",
            ...
            addCoursesFailed: "Kurse konnten nicht hinzugefügt werden.",
            readProfileBoxesFailed: "Kurse konnten nicht geladen werden.",
            saveBoxFailed: "Lern-Box konnte nicht gespeichert werden.",
            readBoxFailed: "Lern-Box konnte nicht geladen werden.",
            readCoursesOfBoxFailed: "Kurse konnten nicht geladen werden.",
            removeCoursesFromUserFailed: "Der Kurs konnte nicht vom Benutzer entfernt werden.",
            deleteBoxFailed: "Die Lern-Box konnte nicht gelöscht werden.",
            scoreCardFailed: "Karte konnte nicht bewertet werden.",
            passwordMismatch: "Passwörter stimmen nicht überein.",
            updatePasswordFailed: "Passwort ändern schlug fehl.",
            checkUsernameFailed: "Benutzername konnte nicht überprüft werden.",
            registerUserFailed: "Das Registieren des Benutzers schlug fehl.",
            confirmEmailFailed: "Das Bestätigen der Email-Adresse schlug fehl.",
            fillBoxWithCardsFailed: "Das Füllen der Lern-Box mit den Karten schlug fehl.",
            removeFromBoxFailed: "Die Karte konnte nicht entfernt werden.",
            readReinforceCardsFailed: "Die Karten zum Festigen konnten nicht geladen werden.",
            recalulateScheduledCardsFailed: "Der Zeitplan konnte nicht neu berechnet werden."
        },
        user: {
            profile: "Mein Profil",
            username: "Benutzername",
    ...
    en: {
        ...
        error: {
            readPublicCoursesFailed: "Failed to load public courses.",
            readPublicLessonsFailed: "Failed to load public lessons.",
            readPublicTestsFailed: "Failed to load public tests.",
            readPublicTestFailed: "Failed to load public test.",
            ...
            readLastResultFailed: "Failed to read last result.",
            ...
            readProfileBoxesFailed: "Failed to load courses.",
            saveBoxFailed: "Failed to save box.",
            readBoxFailed: "Failed to load box.",
            readCoursesOfBoxFailed: "Failed to load courses.",
            removeCoursesFromUserFailed: "Failed to remove course from user.",
            deleteBoxFailed: "Failed to delete box.",
            scoreCardFailed: "Failed to score card.",
            ...
            confirmEmailFailed: "Failed to confirm email.",
            fillBoxWithCardsFailed: "Failed to fill box with cards.",
            removeFromBoxFailed: "Failed to remove card.",
            readReinforceCardsFailed: "Failed to load reinforce cards.",
            recalulateScheduledCardsFailed: "Failed to recalculate schedule."
        },
        user: {
            profile: "My Profile",
            username: "Username",
