...
export default class EventListenerRegistrationCategory {
	...
	static init() {
		...
		ACEController.registerListener('category.InviteUserClickOkEvent', AppState.set_authorView_categoryTree_displayInviteUser);
		ACEController.registerListener('category.InviteUserClickOkEvent', AppState.set_authorView_categoryTree_usernameSearchString);
		ACEController.registerListener('category.GetInvitedUsernamesOkEvent', AppState.set_authorView_categoryTree_invitedUsernames);
		ACEController.registerListener('category.CancelInviteUserOkEvent', AppState.set_authorView_categoryTree_displayInviteUser);
		ACEController.registerListener('category.CancelInviteUserOkEvent', AppState.set_authorView_categoryTree_usernameSearchString);
		ACEController.registerListener('category.CancelInviteUserOkEvent', AppState.set_authorView_categoryTree_invitedUsernames);
		ACEController.registerListener('category.CancelInviteUserOkEvent', AppState.set_authorView_categoryTree_usernames);
		ACEController.registerListener('category.InvitedUsernameChangedOkEvent', AppState.set_authorView_categoryTree_usernameSearchString);
		ACEController.registerListener('category.InvitedUsernameChangedTooShortEvent', AppState.set_authorView_categoryTree_usernames);
		ACEController.registerListener('category.SearchUsernameOkEvent', AppState.set_authorView_categoryTree_usernames);
		ACEController.registerListener('category.InviteUserOkEvent', AppState.set_authorView_categoryTree_displayInviteUser);
		ACEController.registerListener('category.InviteUserOkEvent', AppState.set_authorView_categoryTree_usernameSearchString);
		ACEController.registerListener('category.InviteUserOkEvent', AppState.set_authorView_categoryTree_invitedUsernames);
		ACEController.registerListener('category.InviteUserOkEvent', AppState.set_authorView_categoryTree_usernames);
