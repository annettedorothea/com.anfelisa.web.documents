...
export function get_state_State_displaySaveBugDialog() {
	return state.displaySaveBugDialog;
}
...
export function get_state_State_data_BoxSettings_boxId() {
...
export function get_state_State_data_BoxSettings_maxInterval() {
...
export function get_state_State_data_BoxSettings_maxIntervalInvalid() {
	return state.data.maxIntervalInvalid;
}
...
export function get_state_State_data_BoxSettings_maxCardsPerDay() {
...
export function get_state_State_data_BoxSettings_maxCardsPerDayInvalid() {
	return state.data.maxCardsPerDayInvalid;
}
...
export function get_state_State_data_BoxSettings_dictionaryLookup() {
	return state.data.dictionaryLookup;
}
...
export function get_state_State_data_BoxSettings_dictionaryLookupInvalid() {
	return state.data.dictionaryLookupInvalid;
}
...
export function get_state_State_data_BoxSettings_wantedLanguage() {
	return state.data.wantedLanguage;
}
...
export function get_state_State_data_BoxSettings_givenLanguage() {
	return state.data.givenLanguage;
}
...
export function get_state_State_data_BoxSettings_categoryName() {
...
export function get_state_State_data_BoxSettings_categoryId() {
...
export function get_state_State_data_Card_openTodaysCards() {
	return state.data.openTodaysCards;
}
...
export function get_state_State_data_Card_allTodaysCards() {
	return state.data.allTodaysCards;
}
...
export function get_state_State_data_AuthorView_categoryTree_CategoryTree_previewCsv() {
	return state.data.categoryTree.previewCsv;
}
...
export function get_state_State_data_AuthorView_cardView_CardView_filterNonScheduled() {
	return state.data.cardView.filterNonScheduled;
}
...
export function get_state_State_data_AuthorView_cardView_CardView_dragTargetCardId() {
	return state.data.cardView.dragTargetCardId;
}
