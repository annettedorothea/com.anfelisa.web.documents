...
import PasswordChangedMismatchEvent from "../../../src/common/events/PasswordChangedMismatchEvent";
import PasswordChangedMatchEvent from "../../../src/common/events/PasswordChangedMatchEvent";

export default class AbstractPasswordChangedCommand extends Command {
    constructor(commandData) {
        super(commandData, "common.PasswordChangedCommand");
