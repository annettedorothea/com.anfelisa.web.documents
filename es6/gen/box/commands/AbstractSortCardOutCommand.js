...
export default class AbstractSortCardOutCommand extends Command {
	...
	execute() {
	    return new Promise((resolve, reject) => {
			...
			this.httpPost(`/${Utils.getRootPath()}/cards/sort-out?uuid=${this.commandData.uuid}`, true, payload).then((data) => {
