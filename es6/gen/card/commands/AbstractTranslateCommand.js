...
export default class AbstractTranslateCommand extends AsynchronousCommand {
	...
	addWantedFetchedOutcome() {
		this.commandData.outcomes.push("wantedFetched");
	}
	addGivenFetchedOutcome() {
		this.commandData.outcomes.push("givenFetched");
	}
	addErrorOutcome() {
	...
	addTargetNotEmtpyOutcome() {
		this.commandData.outcomes.push("targetNotEmtpy");
	}

    publishEvents() {
		let promises = [];
	    
		if (this.commandData.outcomes.includes("wantedFetched")) {
		...
		if (this.commandData.outcomes.includes("givenFetched")) {
