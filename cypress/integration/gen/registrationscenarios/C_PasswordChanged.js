...
import * as Verifications from "../../../acegen/src/registrationscenarios/C_PasswordChangedVerifications";

const testId = ScenarioUtils.testId();

context('C_PasswordChanged', () => {
    beforeEach(() => {
    ...
    it('password passwordMismatch registerDisabled', () => {
